...
% Indizes für untere und obere Azimuthwinkel ermitteln
floor_az_floor_el = find(floor_el_angles < az_deg);
floor_az_floor_el = floor_az_floor_el(end);
floor_az_ceil_el = find(ceil_el_angles < az_deg);
floor_az_ceil_el = floor_az_ceil_el(end);

ceil_az_floor_el = find(floor_el_angles > az_deg);
ceil_az_floor_el = ceil_az_floor_el(1);
ceil_az_ceil_el = find(ceil_el_angles > az_deg);
ceil_az_ceil_el = ceil_az_ceil_el(1);
